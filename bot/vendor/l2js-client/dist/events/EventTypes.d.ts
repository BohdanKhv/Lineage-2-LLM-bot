...
export declare type EventHandlerType = OnLoggedIn | OnLoggedInEvent | OnPacketReceivedEvent | OnPacketSentEvent | OnPartyRequestEvent | OnDieEvent | OnTargetSelectedEvent | OnMyTargetSelectedEvent | OnAttackedEvent | OnRequestedDuelEvent | OnStartMovingEvent | OnStopMovingEvent | OnCraftResultEvent | OnPartySmallWindow | OnPartyMemberPosition | OnCharInfo | OnRevive | OnConfirmDlg | OnSystemMessage | OnCreatureSay | OnRecipeBookEvent | OnNpcHtmlMessage | OnNpcQuestHtmlMessage | OnPartySpelled;
