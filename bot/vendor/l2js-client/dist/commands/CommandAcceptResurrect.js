...
class CommandAcceptResurrect extends AbstractGameCommand_1.default {
    execute() {
        var _a, _b, _c;
        if (typeof ((_a = this.GameClient) === null || _a === void 0 ? void 0 : _a.LastConfirmMessageId) !== "undefined" &&
            ...
            (_c = this.GameClient) === null || _c === void 0 ? void 0 : _c.sendPacket(new DlgAnswer_1.default(this.GameClient.LastConfirmMessageId, 1, this.GameClient.LastConfirmMessageRequesterId));
        }
    }
}
exports.default = CommandAcceptResurrect;
