...
const AttackRequest_1 = __importDefault(require("../network/outgoing/game/AttackRequest"));
const AbstractGameCommand_1 = __importDefault(require("./AbstractGameCommand"));
class CommandAttack extends AbstractGameCommand_1.default {
    execute(object, shift) {
        ...
        if (me) {
            ...
            (_b = this.GameClient) === null || _b === void 0 ? void 0 : _b.sendPacket(new AttackRequest_1.default(object, me.X, me.Y, me.Z, forceShift));
        }
    }
}
exports.default = CommandAttack;
