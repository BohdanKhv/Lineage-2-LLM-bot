...
class BlowfishEngine {
    constructor() {
        this.S0 = new Array(BlowfishEngine.SBOX_SK);
        this.S1 = new Array(BlowfishEngine.SBOX_SK);
        this.S2 = new Array(BlowfishEngine.SBOX_SK);
        this.S3 = new Array(BlowfishEngine.SBOX_SK);
        this.P = new Array(BlowfishEngine.P_SZ);
    ...
    bytesTo32Bits(b, i) {
        return this.signedToUnsigned(((b[i + 3] & 0xff) << 24) | ((b[i + 2] & 0xff) << 16) | ((b[i + 1] & 0xff) << 8) | (b[i] & 0xff));
    }
    bits32ToBytes(inb, b, offset) {
        b[offset] = inb;
        b[offset + 1] = inb >> 8;
        b[offset + 2] = inb >> 16;
        b[offset + 3] = inb >> 24;
...
exports.default = BlowfishEngine;
BlowfishEngine.KP = [
...
BlowfishEngine.ROUNDS = 16;
BlowfishEngine.BLOCK_SIZE = 8;
BlowfishEngine.SBOX_SK = 256;
BlowfishEngine.P_SZ = BlowfishEngine.ROUNDS + 2;
